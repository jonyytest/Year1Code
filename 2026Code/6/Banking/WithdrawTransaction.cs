class WithdrawTransaction
{
    ...
    public void Print()
    {
        ...
        {
            Console.WriteLine("Withdraw Status: Successfully withdrew " + _amount.ToString("C") + " from " + _account._Name());
        }
        else if (_reversed)
        {
            Console.WriteLine("Withrdraw Status: Transaction was successfully reversed.");
        }
    }
    ...
    public void Execute()
    {
        ...
        bool withdrawalResult = _account.Withdraw((double)_amount);
        if (!withdrawalResult)
        {
    ...
    public void Rollback()
    {
        ...
        _account.Deposit((double)_amount);
        _reversed = true;
    }
}